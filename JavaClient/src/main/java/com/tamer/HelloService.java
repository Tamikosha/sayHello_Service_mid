 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://iitu.kz/", wsdlLocation = "http://desktop-9rsjn82:8080/JavaEE-WS-1.0-SNAPSHOT/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://iitu.kz/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://desktop-9rsjn82:8080/JavaEE-WS-1.0-SNAPSHOT/HelloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://iitu.kz/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://iitu.kz/", "HelloPort"), Hello.class, features);
    }
